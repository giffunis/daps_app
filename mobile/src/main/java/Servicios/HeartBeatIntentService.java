...
public class HeartBeatIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "Servicios.action.FOO";
    private static final String ACTION_BAZ = "Servicios.action.BAZ";
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, HeartBeatIntentService.class);
